import sys, random
from snake_assets import pg, window, color_goldenrod, color_red, score, backgroundScreen, background_gameOver_Screen, showScore, cleanScreen, writeScreen
